...
import { MAX_LIBRARY_SCOPE_ID_BYTES, MAX_LIBRARY_SCOPE_TOKEN_BYTES } from "./library-scope-limits";
...
/** Kept as a graph-module alias for the shared Library scope bound. */
export const MAX_CITATION_GRAPH_LIBRARY_ID_BYTES = MAX_LIBRARY_SCOPE_ID_BYTES;
/** Kept as a graph-module alias for the shared Library scope bound. */
export const MAX_CITATION_GRAPH_SCOPE_TOKEN_BYTES = MAX_LIBRARY_SCOPE_TOKEN_BYTES;
