...
![AI 闪卡](./assets/screenshots/flashcards.png)
...
桌面壳采用 Electron:领域逻辑全部在 `packages/`(纯 TS、平台无关),Electron 主进程提供 SQLite / 无 CORS HTTP / 文件系统 / 通知 / 内置浏览器,经 preload 的 `window.aura` 桥接给渲染进程。架构详见 [apps/desktop/README.md](./apps/desktop/README.md)。
